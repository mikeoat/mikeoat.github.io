import { a5 as attr_class, a6 as clsx, c as attr, b as escape_html, a as attr_style, s as stringify } from "./renderer.js";
function AudioPlayer($$renderer, $$props) {
  ...
  $$renderer.push(`<div${attr_class(clsx(["player", { paused }]), "svelte-11ffgw9")}><audio${attr("src", src)}></audio> <button class="play svelte-11ffgw9"${attr("aria-label", "play")}></button> <div class="info svelte-11ffgw9"><div class="description svelte-11ffgw9"><marquee direction="right" behavior="alternate" style="z-index:0; font-size: 50px; font-weight:bold; color: #dd5500; margin-bottom:8px; text-align:left">${escape_html(title)}</marquee></div> <div class="time svelte-11ffgw9"><span class="svelte-11ffgw9">${escape_html(format(time))}</span> <div class="slider svelte-11ffgw9"><div class="progress svelte-11ffgw9"${attr_style(`--progress: ${stringify(time / duration)}%`)}></div></div> <span class="svelte-11ffgw9">${escape_html("--:--")}</span></div></div></div>`);
}
const projects = [
  {
    link: "https://smilleyhasawebsite.com/",
    title: "redo of smilley's website",
    blurb: "website created for the artist smilley with sveltekit and love",
  ...
  },
  {
    ...
    blurb: "a novel synthesis method in which the singing sand dune phenomenon was simulated using the discrete element method (research article pending publishing). <a href='https://www.youtube.com/watch?v=6qA7mPoIyf8'>watch an explainer video (youtube)",
    tags: ["website", "development"],
    date: "12-11-2025"
  },
  {
  ...
  {
    link: "https://github.com/mikgmcd/mikgmcd.github.io/tree/main",
    title: "smilley's website",
    blurb: "website created for the artist smilley with html, css, and elbow grease",
    tags: ["website", "development"],
    date: "04-20-2023"
  },
  {
